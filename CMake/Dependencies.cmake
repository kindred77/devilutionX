...
if(NOT DEFINED DEVILUTIONX_SYSTEM_BOOST)
  find_package(boost 1.82 QUIET)
  if(boost_FOUND)
    message("-- Found boost")
  else()
    message("-- Suitable system boost package not found, will use boost from source")
    set(DEVILUTIONX_SYSTEM_BOOST OFF)
  endif()
endif()
dependency_options("boost" DEVILUTIONX_SYSTEM_BOOST ON DEVILUTIONX_STATIC_BOOST)
if(DEVILUTIONX_SYSTEM_BOOST)
